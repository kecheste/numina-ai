...
import { apiFetchTestQuestions } from "@/lib/api-client";
...
export function TestFlow({
  ...
  const isQuestionlessComputedTest =
    Boolean(autoGenerated) || testId === 2 || testId === 5 || testId === 6;
  ...
  if (flowState === "failed") {
    return (
      <div className="absolute inset-0 z-50 flex flex-col items-center justify-center bg-black px-6 gap-4">
                    ...
                    style={{
                      ...
                      color:
                        color === "Yellow" || color === "White"
                          ? "black"
                          : "white",
                      opacity: answers[currentQuestion.id] === color ? 1 : 0.6,
                    }}
                  >
                    {color}
                  </button>
            ...
            {currentQuestion?.type === "slider" &&
              (() => {
                const value =
                  ...
                  Math.round(
                    (currentQuestion.slider_min + currentQuestion.slider_max) /
                      2,
                  );
                const range =
                  currentQuestion.slider_max - currentQuestion.slider_min || 1;
                const pct = ((value - currentQuestion.slider_min) / range) * 100;
                return (
                  <div className="px-2">
                    <input
                      type="range"

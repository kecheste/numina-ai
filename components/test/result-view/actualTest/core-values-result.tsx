        ...
        <div className="flex flex-col px-[32px] pt-6 pb-12 flex-1 overflow-y-auto">
          ...
          <div className="flex flex-col items-center mb-[40px]">
            ...
            <p className="text-[#D9D9D9] text-[11px] font-[300] pt-[8px] text-center px-4">
              {data?.oneSentenceInsight || "Stability, reliability, and control appear to be your strongest guiding needs."}
            </p>
          </div>
          ...
          <BluePrint title="Core Values Map" blueprint={data?.summary} />
